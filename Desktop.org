...
** Volume
   ...
   To simplify invocation of the command, create a wrapperr script per machine with all
...
** Google Cloud Platform
   #+begin_src bash  :tangle ~/.local/share/applications/gcp.desktop
     ...
     Comment=GCP
     Exec=x-www-browser --new-window https://console.cloud.google.com/compute/instances?authuser=0
...
** Google Maps
   #+begin_src bash  :tangle ~/.local/share/applications/google-maps.desktop
     ...
     Name=Google Maps
     Comment=
     Exec=x-www-browser --new-window https://maps.google.com?authuser=1
