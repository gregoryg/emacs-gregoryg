...
** Google Cloud Platform
   #+begin_src bash  :tangle ~/.local/share/applications/gcp.desktop
     ...
     Comment=GCP
     Exec=xdg-open https://console.cloud.google.com/compute/instances?authuser=1
     Icon= /home/gregj/.local/share/pixmaps/google-cloud-logo.png
     Terminal=false
     Type=Application
...
** Google Calendar
   #+begin_src conf :tangle ~/.local/share/applications/gcalendar.desktop
     ...
     Exec=xdg-open https://calendar.google.com/calendar/u/1/
...
** Microsoft Teams
   ...
   #+begin_src conf :tangle no
         # ~/.local/share/applications/teams-browser.desktop
         [Desktop Entry]
...
** Spotify in browser
   ...
   #+end_src
** Nyaancat Studio
   #+begin_src conf :tangle ~/.local/share/applications/nyaancat.desktop
     [Desktop Entry]
     Name=Nyaancat Studio
     Comment=
     Exec=google-chrome --incognito http://localhost:8888/
     Icon= /home/gregj/.local/share/pixmaps/nyaancat-icon.png
     Terminal=false
     Type=Application
...
*** Cuphead
    #+begin_src conf :tangle no
  ~/.local/share/applications/steam-cuphead.desktop
      [Desktop Entry]
      Name=Cuphead
...
*** Overcooked! 2
    #+begin_src conf :tangle no
 ~/.local/share/applications/steam-overcooked2.desktop
      [Desktop Entry]
      Name=Overcooked! 2
      Comment=Play this game on Steam
...
*** Portal 2
    #+begin_src conf :tangle no
 ~/.local/share/applications/steam-portal2.desktop
      [Desktop Entry]
      Name=Portal 2
      Comment=Play this game on Steam
...
*** Rocket League
    #+begin_src conf :tangle no
 ~/.local/share/applications/steam-rocketleague.desktop
      [Desktop Entry]
      Name=Rocket League
      Comment=Play this game on Steam
...
*** Starbound
    #+begin_src conf :tangle no
 ~/.local/share/applications/steam-starbound.desktop
      [Desktop Entry]
      Name=Starbound
      Comment=Play this game on Steam
...
*** Stardew Valley
    #+begin_src conf :tangle no
 ~/.local/share/applications/steam-stardewvalley.desktop
      [Desktop Entry]
      Name=Stardew Valley
      Comment=Play this game on Steam
...
** TigerGraph Documentation
   #+begin_src conf :tangle ~/.local/share/applications/tigergraph-documentation.desktop
     ...
     Comment=Ohai
     Exec=xdg-open https://docs.tigergraph.com/home/
