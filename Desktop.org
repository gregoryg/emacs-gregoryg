...
** Dired
   ...
   #+end_src
** Discord
   #+begin_src conf :tangle ~/.local/share/applications/discord.desktop
     [Desktop Entry]
     Encoding=UTF-8
     Name=Discord
     Comment=Communicate
...
** Rotate Wallpaper
   ...
   #+end_src
** Signal
   #+begin_src conf :tangle ~/.local/share/applications/signal.desktop
     [Desktop Entry]
     Name=Signal
     Comment=Signal
   ...
   #+end_src
** Slack
   #+begin_src conf :tangle ~/.local/share/applications/slack.desktop
     [Desktop Entry]
     Name=Slack
     Comment=Slack
...
** Solaar Logitech
   ...
   #+end_src
** Spotify
   #+begin_src conf :tangle ~/.local/share/applications/spotify.desktop
     [Desktop Entry]
     Name=Spotify
     Comment=Spotify
...
** Zoom
   Use this if you are not using the OS package manager installation - set =:tangle no= if
   you are
   #+begin_src conf :tangle ~/.local/share/applications/zoom.desktop
     [Desktop Entry]
     Encoding=UTF-8
     Name=Zoom
     GenericName=Zoom
