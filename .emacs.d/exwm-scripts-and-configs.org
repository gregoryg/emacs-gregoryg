...
** Calendar
   #+begin_src conf :tangle ~/.local/share/applications/fcalendar.desktop
     [Desktop Entry]
     Name=Calendar
     Comment=Outlook Calendar in Browser
     Exec=x-www-browser --new-window https://outlook.office.com/calendar/view/day
...
** Clarizen Timesheets
   #+begin_src conf :tangle ~/.local/share/applications/clarizen.desktop
     ...
     Exec=x-www-browser --new-window https://eu1.clarizen.com/Clarizen/TeamSpace/Timesheet
...
** Google Cloud Platform
   #+begin_src bash  :tangle ~/.local/share/applications/gcp.desktop
     ...
     Comment=GCP
     Exec=x-www-browser --new-window https://console.cloud.google.com/compute/instances?authuser=1&project=tigergraph-sales
...
** Hangouts / Google Chat
   #+begin_src conf :tangle ~/.local/share/applications/fhangouts.desktop
     ...
     Comment=Google Chat
     Exec=x-www-browser --new-window https://chat.google.com/
...
** Lens for Kubernetes
   Download AppImage binary from the [[https://github.com/lensapp/lens/releases][releases site]]
    #+begin_src conf :tangle ~/.local/share/applications/lens.desktop
      [Desktop Entry]
      Name=Lens
...
** Google Email Gmail
   #+begin_src conf :tangle ~/.local/share/applications/gmail.desktop
     ...
     Exec=x-www-browser --new-window https://gmail.com/
...
** Outlook Email
   #+begin_src conf :tangle ~/.local/share/applications/femail.desktop
     [Desktop Entry]
     Name=Mail Email
     Comment=Outlook EMail in Browser
     Exec=x-www-browser --new-window https://outlook.office.com/mail/inbox
...
** Neo4j Desktop
   ...
   #+end_src
** Okta
   #+begin_src conf :tangle ~/.local/share/applications/okta.desktop
     [Desktop Entry]
     Name=SUSE Okta
     Comment=SUSE Okta SSO
     Exec=x-www-browser --new-window https://suse.okta.com
     Icon= /home/gregj/.local/share/pixmaps/okta-dev.png
     Terminal=false
     Type=Application
     Categories=Office;SSO;
   #+end_src
...
** Rocket Chat
   #+begin_src conf :tangle ~/.local/share/applications/rocketchat.desktop
     ...
     Name=Rocket.Chat
     Comment=
     Exec=x-www-browser --new-window https://chat.suse.de/
...
** Tigergraph GraphStudio
   #+begin_src conf :tangle ~/.local/share/applications/tigergraph-graphstudio.desktop
     ...
     Comment=
     Exec=x-www-browser --new-window http://protomolecule.magichome:30240/
...
** Zendesk
   #+begin_src conf :tangle ~/.local/share/applications/zendesk.desktop
     ...
     Exec=x-www-browser --new-window https://rancher.zendesk.com/agent/dashboard
