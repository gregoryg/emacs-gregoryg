...
** Google Calendar
   #+begin_src conf :tangle ~/.local/share/applications/gcalendar.desktop
     ...
     Exec=x-www-browser --new-window https://calendar.google.com/calendar/u/1/
...
** Google Gmail
   #+begin_src conf :tangle ~/.local/share/applications/gmail.desktop
     ...
     Exec=x-www-browser --new-window https://mail.google.com/mail/u/1/#search/in:inbox+is:unread
