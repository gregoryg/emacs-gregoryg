  ...
  :END:
   #+begin_src emacs-lisp
     (defun gjg/go-dark ()
       ...
       (start-process "gsettings-color" nil "gsettings" "set" "org.gnome.desktop.interface" "color-scheme" "prefer-dark")
       (start-process "gsettings-color" nil "gsettings" "set" "org.gnome.desktop.interface" "gtk-theme" "Adwaita-dark"))
     ...
     (defun gjg/go-light ()
       ...
       (start-process "gsettings-color" nil "gsettings" "set" "org.gnome.desktop.interface" "color-scheme" "prefer-light")
       (start-process "gsettings-color" nil "gsettings" "set" "org.gnome.desktop.interface" "gtk-theme" "Adwaita"))
   #+end_src
